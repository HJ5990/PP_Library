--CREATE USER PP_L IDENTIFIED BY PP_L;
--GRANT RESOURCE, CONNECT TO PP_L;
---- 뷰 생성권한
--GRANT CREATE VIEW TO PP_L;
...
INSERT INTO BOOK VALUES (SEQ_BOOK.NEXTVAL, 1, '달러구트 꿈 백화점', '이미예', '2020-07-08', 3);
...
INSERT INTO BOOK VALUES (SEQ_BOOK.NEXTVAL, 3, '바로 쓰는 영어', '셀리', '2022-07-20', 3);
...
INSERT INTO RENTALLOG VALUES (SEQ_RENT.NEXTVAL, '2023-09-23', 204, 102, '대여', NULL);
...
INSERT INTO RENTALLOG VALUES (SEQ_RENT.NEXTVAL, '2023-09-25', 208, 105, '대여', NULL);
INSERT INTO RENTALLOG VALUES (SEQ_RENT.NEXTVAL, '2023-09-26', 202, 117, '대여', NULL);
INSERT INTO RENTALLOG VALUES (SEQ_RENT.NEXTVAL, '2023-09-28', 202, 109, '대여', NULL);
